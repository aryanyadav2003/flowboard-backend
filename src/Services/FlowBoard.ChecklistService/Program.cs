...
using FlowBoard.ChecklistService.Mappings;
using FlowBoard.ChecklistService.Repositories;
...
{
    c.SwaggerDoc("v1", new() { Title = "Checklist Service", Version = "v1" });
...
builder.Services.AddAutoMapper(typeof(ChecklistMappingProfile));
...
scope.ServiceProvider
     .GetRequiredService<ChecklistDbContext>()
     .Database.Migrate();
