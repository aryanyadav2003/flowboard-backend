...
using FlowBoard.BoardService.Mappings;
using FlowBoard.BoardService.Repositories;
...
{
    c.SwaggerDoc("v1", new() { Title = "Board Service", Version = "v1" });
...
builder.Services.AddDbContext<BoardDbContext>(opts =>
